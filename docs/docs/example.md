...
const proofRequest = new ProofRequest({addresses, message, rawSignature, url: PROOFS_API})
...
execSync(`snarkjs groth16 verify ./verification_key.json ./proof.json ./public.json`)
