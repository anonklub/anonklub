...
ensGovernanceTransforms[0] = new AutoPaginationTransform({
                  apiName: "ens-governance",
...
cryptopunksTransforms[0] = new AutoPaginationTransform({
                  apiName: "cryptopunks",
                  config: {"validateSchema":true,"limitOfRecords":1000},
                  baseDir,
                  cache,
...
beaconDepositorsTransforms[0] = new AutoPaginationTransform({
                  apiName: "beacon-depositors",
                  config: {"validateSchema":true,"limitOfRecords":1000},
                  baseDir,
                  cache,
                  pubsub,
