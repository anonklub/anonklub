import inquirer, { type DistinctQuestion, type QuestionCollection } from 'inquirer'
import inquirerFuzzyPath from 'inquirer-fuzzy-path'
import { join } from 'node:path'

inquirer.registerPrompt('fuzzypath', inquirerFuzzyPath)

export const prompt = <T>(questions: QuestionCollection | DistinctQuestion) => async (): Promise<T> => {
...
const excludeRegex = /(coverage|dist|Library|node_modules|turbo|package|tsconfig|\/\.\w+)/
